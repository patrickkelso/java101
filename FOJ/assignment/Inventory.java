...
public class Inventory
{
  ...
  private static ArrayList<ProductLine> products;
  ...
  public Inventory() {
    ...
    public static void pointOfSale() {
      ...
      ProductLine product = getProduct(products, enteredcode);
      if (product == null)
  ...
  private static ProductLine getProduct(ArrayList<ProductLine> products, String name) {
    for (ProductLine product : products)
      if (product.getProductCode().equals(name))
        return product;
    return null;
  }
